...
// These id's and secrets should come from .env file.
const CLIENT_ID = '795090287571-skp802kpo5n7p5f7fdkq51lc10d186p4.apps.googleusercontent.com';
const CLEINT_SECRET = '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';
const REDIRECT_URI = 'https://developers.google.com/oauthplayground';
const REFRESH_TOKEN = '1//04gSfomIp63H_CgYIARAAGAQSNwF-L9IrzE6I4u4jIUG4R9iX7ot4dvkPuKuOjBHdA2afk5Trba_E3A-zY_sfDzP6m0EHT1i6_UI';
...
export async function sendMail(email, token) {
    try {
        ...
        const mailOptions = {
            ...
            subject: 'Hello from gmail using API',
            text: 'Hello from gmail email using API',
            html: `<h1>Hello from gmail email using API,,,,${token}</h1>`,
        };
